...
with pm.Model() as pymc_mod:
    theta = pm.Beta("theta", alpha=4, beta=2)          # pulled away from 0, unlike MLE
    k = pm.HalfNormal("k", sigma=150)
    s = pm.Gamma("s", alpha=2, beta=1)
...
idata.to_netcdf("dfm_kalman_pymc_fit.nc")
summary.to_csv("dfm_kalman_pymc_summary.csv")
print("\nDone.")